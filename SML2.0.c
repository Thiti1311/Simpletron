...
*/
                ...
                printf("\n* Carga do programa concluida    *\n");
                printf("* Iniciando execuÁ„o do programa   *\n");
                system("pause");
                    ...
                    switch (operationCode){
                        ...
                        case DIVIDE:
                            if (memory[operand] == 0 || accumulator == 0){
                                printf("*** Tentativa de divis„o por zero ***\n*** ExecuÁ„o do Simpletron encerrada de forma anormal. ***\n");
                                operationCode = HALT;
                                continue;
                            }else{
                                accumulator /= memory[operand];
                        ...
                        case HALT: case 99:
                            ...
                            printf("\n*** ExecuÁ„o do Simpletron encerrada ***\n");
                            break;
                    }
                }
            }
...
int menu_mostrar(){
    ...
    {
        printf("\n");
        printf("* Escolha uma das opÁıes informadas abaixo   *\n");
